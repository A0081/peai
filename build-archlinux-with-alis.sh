...
echo
	...
	buildFolder=$HOME"/Peai-build"
	outFolder=$HOME"/Peai-Out"
...
echo
	...
	echo
	echo "Git clone ALIS Peai"
	mkdir $buildFolder/archiso/airootfs/alis
	git clone https://github.com/ariser-installer/alis-Peai $buildFolder/archiso/airootfs/alis
